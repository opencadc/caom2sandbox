...
package ca.nrc.cadc.sc2repo.integration;


import ca.nrc.cadc.caom2.repo.integration.CaomRepoTupleTests;
 ...
 * @author pdowler
 */
public class RepoTupleGenIntTest extends CaomRepoTupleTests
{
    private static final Logger log = Logger.getLogger(RepoIntTest.class);
    static
    {
